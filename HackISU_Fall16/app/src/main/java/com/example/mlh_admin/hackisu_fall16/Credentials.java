...
public class Credentials {
    ...
    static final String CLIENT_ID = "Ev2QsPlToNGhtVwxNeajw-RfbtyMRIjBGs7WD38A";
    static final String CLIENT_SECRET = "muh1suKem8hzvxlj06qE-usdrHC3zoInqOSsziIu";
    // AWS Services
    static final String access_key_id = "AKIAJGN4KSUT4ADFA2JA";
    static final String secret_access_key = "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";
